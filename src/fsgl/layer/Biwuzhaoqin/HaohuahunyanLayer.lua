...
--Date
--此文件由[BabeLua]插件自动生成
local HaohuahunyanLayer = class("HaohuahunyanLayer",function()
...
function HaohuahunyanLayer:ctor()
	self:init()
end

function HaohuahunyanLayer:init()

	local title = cc.Sprite:create("res/image/Biwuzhaoqin/title_hunyanlist.png")
	self:addChild(title)
...
function HaohuahunyanLayer:buildCell(index,cell)
	for i = 1, 2 do
...
function HaohuahunyanLayer:create()
	return HaohuahunyanLayer.new()
end

return HaohuahunyanLayer
