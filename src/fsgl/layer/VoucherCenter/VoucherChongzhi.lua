...
function VoucherChongzhi:createTableViewCell(index,cell)
	for i = 1, 3 do
		...
		local itemName = XTHDLabel:create("萌新补寄包",20)--,"res/fonts/hkys.ttf")
		...
		local itemNode = cc.Sprite:create("res/image/VoucherCenter/viplibao/itemNode.png")
		...
		local money = XTHDLabel:create("100",20)--,"res/fonts/hkys.ttf")
...
function VoucherChongzhi:create()
	return VoucherChongzhi.new()
end
