--[[--82 少年金灵圣母]]
local Snjlsm = class("Snjlsm", function ( params )
...
function Snjlsm:doAnimationEvent(event)
...
function Snjlsm:doSuperAnimationStart(event)
	-- 
...
function Snjlsm:create(params)
	return Snjlsm.new(params)
end
