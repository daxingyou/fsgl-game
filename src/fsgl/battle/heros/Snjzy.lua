--[[--96少年姜子牙]]
local Snjzy = class("Snjzy", function ( params )
...
function Snjzy:doAnimationEvent(event)
...
function Snjzy:create(params)
	return Snjzy.new(params)
end

function Snjzy:doAnimationStart(event)
