--[[少年土行孙 86]]
local Sntxs = class("Sntxs", function ( params )
	if not params then
		params = {}
	end
	-- params.id = 17
...
function Sntxs:doAnimationEvent(event)
...
function Sntxs:doAnimationStart(event)
	local scene = cc.Director:getInstance():getRunningScene()
...
function Sntxs:create(params)
	return Sntxs.new(params)
end
