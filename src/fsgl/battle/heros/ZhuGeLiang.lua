...
local ZhuGeLiang = class("ZhuGeLiang", function ( params )
...
function ZhuGeLiang:_initCache()
...
function ZhuGeLiang:_initYD_Cache()
...
function ZhuGeLiang:doAnimationEvent(event)
	--[[注意：
...
function ZhuGeLiang:showWolrdEff( isDelay )
...
function ZhuGeLiang:_doEvent_Atk2( _skillData, targets, posYPlus )
...
function ZhuGeLiang:_doStart_Atk2( posYPlus )
	local _posYPlus = posYPlus or 0
	--[[--战车]]
...
function ZhuGeLiang:doAnimationStart(event)
...
function ZhuGeLiang:create(params)
	return ZhuGeLiang.new(params)
end
