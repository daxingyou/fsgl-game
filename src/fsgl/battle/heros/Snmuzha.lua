...
local Snmuzha = class("Snmuzha", function ( params )
	local animal = Character:_create(params)
	return animal
end)

function Snmuzha:_initCache()
...
function Snmuzha:doAnimationEvent(event)
...
function Snmuzha:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function Snmuzha:create(params)
	return Snmuzha.new(params)
end
