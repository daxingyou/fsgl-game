--[[项羽]]
local XiangYu = class("XiangYu", function ( params )
...
function XiangYu:doAnimationEvent(event)
	--[[注意：
...
function XiangYu:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function XiangYu:create(params)
	return XiangYu.new(params)
end
