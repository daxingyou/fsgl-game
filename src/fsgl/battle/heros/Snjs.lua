...
local Snjs = class("Snjs", function ( params )
...
function Snjs:doAnimationEvent(event)
	--[[注意：
...
function Snjs:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function Snjs:create(params)
	return Snjs.new(params)
end
