...
local ZhenFu = class("ZhenFu", function ( params )
	local animal = Character:_create(params)
	return animal
end)

function ZhenFu:_initCache()
...
function ZhenFu:doAnimationEvent(event)
...
function ZhenFu:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function ZhenFu:create(params)
	return ZhenFu.new(params)
end
