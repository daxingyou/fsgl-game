--[[--37祝融夫人]]
local ZhuRongFuRen = class("ZhuRongFuRen", function ( params )
...
function ZhuRongFuRen:_initCache()
...
function ZhuRongFuRen:doAnimationStart(event)
...
function ZhuRongFuRen:doAnimationEvent(event)
...
function ZhuRongFuRen:create(params)
	return ZhuRongFuRen.new(params)
end
