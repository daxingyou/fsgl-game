...
local Snjwh = class("Snjwh", function ( params )
	local animal = Character:_create(params)
	return animal
end)

function Snjwh:_initCache()
...
function Snjwh:doAnimationEvent(event)
...
function Snjwh:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function Snjwh:create(params)
	return Snjwh.new(params)
end
