--[[-- 110少年姬发]]
local Snjifa = class("Snjifa", function ( params )
...
function Snjifa:doAnimationEvent(event)
...
function Snjifa:doSuperAnimationStart(event)
	-- 
...
function Snjifa:create(params)
	return Snjifa.new(params)
end
