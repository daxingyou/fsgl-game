-- 女娲 20
local NvWa = class("NvWa", function ( params )
...
function NvWa:doAnimationEvent(event)
...
function NvWa:setBigToNormal()
	-- local _node = self:getNodeForSlot("qiu")
	-- _node:removeAllChildren()
end

function NvWa:create(params)
	return NvWa.new(params)
end

function NvWa:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
