--[[--28 张辽]]
local ZhangLiao = class("ZhangLiao", function ( params )
...
function ZhangLiao:doAnimationEvent(event)
...
function ZhangLiao:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function ZhangLiao:create(params)
	return ZhangLiao.new(params)
end
