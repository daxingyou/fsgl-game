--[[--少年琼霄]]
local Snqx = class("Snqx", function ( params )
...
function Snqx:doAnimationEvent(event)
...
function Snqx:doAnimationStart(event)
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function Snqx:create(params)
	return Snqx.new(params)
end
