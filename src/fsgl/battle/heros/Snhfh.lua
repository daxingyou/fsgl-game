...
local Snhfh = class("Snhfh", function ( params )
...
function Snhfh:doAnimationEvent(event)
...
function Snhfh:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function Snhfh:create(params)
	return Snhfh.new(params)
end
