...
local YuJi = class("YuJi", function ( params )
...
function YuJi:doAnimationEvent(event)
...
function YuJi:doSuperAnimationStart(event)
	-- 
	local _animalName = self:getNowAniName()
    local _skillData 	  = self:getSkillByAction(_animalName)
...
function YuJi:create(params)
	return YuJi.new(params)
end
