...
local JingKe = class("JingKe", function ( params )
	local animal = Character:_create(params)
	return animal
end)

function JingKe:_initCache()
...
function JingKe:doAnimationEvent(event)
...
function JingKe:doSuperAnimationStart(event)
...
function JingKe:create(params)
	return JingKe.new(params)
end
